          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="font-semibold text-lg mb-0" style={{ color: "var(--heading-color)" }}>
                    <a href={`mailto:${CONTACT.email}`} style={{ color: "var(--heading-color)" }} className="!border-none !bg-none hover:!text-primary">
                      {CONTACT.email}
                    </a>
                  </p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="font-semibold text-lg mb-0" style={{ color: "var(--heading-color)" }}>{CONTACT.location}</p>
                  <p className="text-sm mb-0" style={{ color: "var(--text-color)" }}>{CONTACT.availability}</p>
                </div>
              </div>
            </div>
          </div>
